          ...
          <section className={styles.container}>
            <section className={styles.heroInfo}>
              ...
              <p className={`${styles.subtitle} hero-title`}>
                We are a team of passionate UI/UX Designer and Website
                Developer. We will be happy to collaborate with you and create
                something amazing!
              </p>
        ...
        <Wrapper>
          <section className={`${styles.container_who_we_are}`}>
            ...
            <p className={`${styles.subtitle} section-1`}>
              We are a team of passionate UI/UX Designer, and we believe with
              the right design and strong collaboration, we can support your
              brand growth and help you fulfill your vision and goals.
            </p>
          </section>
        </Wrapper>
      </section>
        ...
        <Wrapper>
          <section className={styles.container_featured_projects}>
            <h2 className={`${styles.title} section-4`}>
              <span className={styles.titleDecoration}>04</span>Featured
              Projects
            </h2>
            <p className={`${styles.subtitle} section-4`}>
              Some of the projects we have made with our amazing clients
            </p>
